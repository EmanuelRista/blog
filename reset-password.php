...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["new_password"]))) {
        $new_password_err = "Per favore inserisci una nuova password.";
...
<div class="wrapper">
    ...
    <p>Compila questo form per resettare la tua password.</p>
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group mb-3">
            ...
            <a class="btn btn-link ml-2" href="admin.php">Indietro</a>
        </div>
    </form>
</div>
